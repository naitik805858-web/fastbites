...
// ---------- Basic brute-force / spam protection ----------
...
function serveStatic(req, res, urlPath) {
  ...
  // Try locating file in public/ first, then fallback to root directory
  let targetPath = path.join(PUBLIC_DIR, relativePath);
  if (!fs.existsSync(targetPath)) {
    // If request has /admin/login.html, check login.html in root
